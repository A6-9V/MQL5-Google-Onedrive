...
def main():
    ...
    # --- ⚡ Bolt: Optimization - Run tests sequentially to avoid ProcessPoolExecutor overhead.
    # For this specific test suite consisting of short subprocess calls, the overhead
    # of creating new processes far exceeds the benefits of parallelization.
    for test in tests:
