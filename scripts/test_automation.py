...
def main():
    ...
    # ⚡ Bolt: Sequential execution for small suites of short-lived tests is faster.
    # The overhead of ProcessPoolExecutor (~1.5s) exceeds the benefits of parallelization here.
    for test in tests:
