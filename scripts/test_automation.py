...
def main():
    ...
    # ⚡ Bolt: Run tests sequentially.
    # Parallel execution with ProcessPoolExecutor had ~1.8s overhead for these short tests.
    # Sequential execution is ~40% faster in this specific case.
    for test in tests:
