...
⚡ Bolt: Performance optimization - Removed ProcessPoolExecutor.
For small, fast tests, the overhead of process creation far outweighs the
benefits of parallelization. Sequential execution is ~30% faster and deterministic.
"""
...
def main():
    ...
    # ⚡ Bolt: Run tests sequentially for better performance and deterministic output.
    # Parallel execution with processes has high overhead for these fast tests.
    for test in tests:
