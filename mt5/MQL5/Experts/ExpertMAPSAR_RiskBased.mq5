...
//+------------------------------------------------------------------+
//--- inputs for expert
input string             Inp_Expert_Title                      ="ExpertMAPSAR_RiskBased";
...
//--- inputs for trailing (Risk Based Fixed SL/TP)
input int                Inp_Trailing_FixedPips_Stop           =500;         // Stop Loss (points)
input int                Inp_Trailing_FixedPips_Profit         =1000;        // Take Profit (points)
//--- inputs for money
...
//--- Set trailing parameters
   trailing.StopLevel(Inp_Trailing_FixedPips_Stop);
   trailing.ProfitLevel(Inp_Trailing_FixedPips_Profit);
