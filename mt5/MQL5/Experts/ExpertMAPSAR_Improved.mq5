...
//+------------------------------------------------------------------+
//--- inputs for expert
input string             Inp_Expert_Title                      ="ExpertMAPSAR_Improved";
int                      Expert_MagicNumber                    =27894;
bool                     Expert_EveryTick                      =false;
//--- inputs for signal
input int                Inp_Signal_MA_Period                  =15;          // MA Period (Optimized default: 15)
input int                Inp_Signal_MA_Shift                   =4;           // MA Shift (Optimized default: 4)
input ENUM_MA_METHOD     Inp_Signal_MA_Method                  =MODE_EMA;    // MA Method (Optimized default: EMA)
...
input double             Inp_Money_SizeOptimized_Percent       =3.0;         // Money Percent (Safe default: 3%)
//+------------------------------------------------------------------+
