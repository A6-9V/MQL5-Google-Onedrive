...
void OnTick()
{
  ...
  // --- SMC / Structure Break Logic (Lazy Calculation) ---
  // PERF: This entire block is skipped if SMC analysis is disabled.
  // This avoids expensive CopyBuffer calls and loops for users not using this feature.
